...
Estate researchers put the administrative burden of a death at **420–500 hours** of the family's time, spread over **12–18 months** — phone trees, forms, and follow-ups, carried by people at the worst moment of their lives. The British have a word for it: *sadmin*.
...
3. The system prompt teaches the Steward to be careful; the gate **makes** it careful. A confused model cannot delete a photo library or move $1,847 — the tool itself says no.
...
3. Keep advancing. Watch Epilogue chase the gym into a written letter, field a $1,847 clawback from the benefits agency (asks you — it's over your threshold), block a fraudulent credit application with the deceased alerts it placed on day one, and write you a weekly note about all of it.
...
```bash
pip install -e ".[dev]"
pytest            # 21 tests, fully offline, < 1s
```
...
- A full case — intake, ~16 matters, ~8 weeks of correspondence — lands around **1–2M tokens ≈ $5–12 on Claude Sonnet via Bedrock**. Against 400+ hours of a family's time, the unit economics are almost embarrassing.

## Could this be a company? (It already is one, twice.)
